...
public class ArticleAction extends BaseAction {
	...
	public String queryArticleList() {
		try {
			...
			article.getPageInfo().setCurrentPage(DigitalUtil.paseInt(request.getParameter("pageNum")));
	...
	private void coverPicPath(ArticleDO article) {
		...
		String fullPicPath = request.getScheme()+"://"+request.getServerName()+request.getContextPath()+"/upload/"+imagePath;
